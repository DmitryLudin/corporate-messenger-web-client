...
import { NamespaceDisplayNameField } from 'pages/namespaces/components/create-namespace/display-name-field';
import { NamespaceNameField } from 'pages/namespaces/components/create-namespace/name-field';
