...
import { CreateNamespaceSection } from 'pages/namespaces/modules/create-namespace';
import { JoinNamespaceSection } from 'pages/namespaces/modules/join-namespace';
import { SelectNamespaceSection } from 'pages/namespaces/modules/select-namespace';
...
export const NamespacesPage = withObserver(NamespacesPageMemo);
